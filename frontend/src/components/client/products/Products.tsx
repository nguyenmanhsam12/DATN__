              ...
              <li className="product-item product-type-variable col-lg-3 col-md-4 col-sm-6 col-xs-6 col-ts-12 style-1">
                <div className="product-inner equal-element">
                  ...
                  <div className="product-thumb">
                    <div className="thumb-inner">
                      <a href="#">
                        <img src="/src/assets/img/product14.png" alt="img" />
                      </a>
                      <div className="thumb-group">
                        <div className="yith-wcwl-add-to-wishlist">
                          <div className="yith-wcwl-add-button">
              ...
              <li className="product-item product-type-variable col-lg-3 col-md-4 col-sm-6 col-xs-6 col-ts-12 style-1">
                <div className="product-inner equal-element">
                  ...
                  <div className="product-thumb">
                    <div className="thumb-inner">
                      <a href="#">
                        <img src="/src/assets/img/product15.jpg" alt="img" />
                      </a>
                      <div className="thumb-group">
                        <div className="yith-wcwl-add-to-wishlist">
                          <div className="yith-wcwl-add-button">
              ...
              <li className="product-item  col-lg-3 col-md-4 col-sm-6 col-xs-6 col-ts-12 style-1">
                <div className="product-inner equal-element">
                  ...
                  <div className="product-thumb">
                    <div className="thumb-inner">
                      <a href="#">
                        <img src="/src/assets/img/product20.png" alt="img" />
                      </a>
                      <div className="thumb-group">
                        <div className="yith-wcwl-add-to-wishlist">
                          <div className="yith-wcwl-add-button">
              ...
              <li className="product-item product-type-variable col-lg-3 col-md-4 col-sm-6 col-xs-6 col-ts-12 style-1">
                <div className="product-inner equal-element">
                  ...
                  <div className="product-thumb">
                    <div className="thumb-inner">
                      <a href="#">
                        <img src="/src/assets/img/product21.png" alt="img" />
                      </a>
                      <div className="thumb-group">
                        <div className="yith-wcwl-add-to-wishlist">
                          <div className="yith-wcwl-add-button">
              ...
              <li className="product-item  col-lg-3 col-md-4 col-sm-6 col-xs-6 col-ts-12 style-1">
                <div className="product-inner equal-element">
                  ...
                  <div className="product-thumb">
                    <div className="thumb-inner">
                      <a href="#">
                        <img src="/src/assets/img/product22.png" alt="img" />
                      </a>
                      <div className="thumb-group">
                        <div className="yith-wcwl-add-to-wishlist">
                          <div className="yith-wcwl-add-button">
              ...
              <li className="product-item  col-lg-3 col-md-4 col-sm-6 col-xs-6 col-ts-12 style-1">
                <div className="product-inner equal-element">
                  ...
                  <div className="product-thumb">
                    <div className="thumb-inner">
                      <a href="#">
                        <img src="/src/assets/img/product23.png" alt="img" />
                      </a>
                      <div className="thumb-group">
                        <div className="yith-wcwl-add-to-wishlist">
                          <div className="yith-wcwl-add-button">
              ...
              <li className="product-item  col-lg-3 col-md-4 col-sm-6 col-xs-6 col-ts-12 style-1">
                <div className="product-inner equal-element">
                  ...
                  <div className="product-thumb">
                    <div className="thumb-inner">
                      <a href="#">
                        <img src="/src/assets/img/product24.png" alt="img" />
                      </a>
                      <div className="thumb-group">
                        <div className="yith-wcwl-add-to-wishlist">
                          <div className="yith-wcwl-add-button">
