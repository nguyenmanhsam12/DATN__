                  ...
                  <ul className="row list-products auto-clear equal-container product-grid">
                    ...
                    <li className="product-item col-lg-3 col-md-4 col-sm-6 col-xs-6 col-ts-12 style-1">
                      <div className="product-inner equal-element">
                        ...
                        <img src="/../../public/assets/img/product25.png" alt="img"/>
                    ...
                    <li className="product-item product-type-variable col-lg-3 col-md-4 col-sm-6 col-xs-6 col-ts-12 style-1">
                      <div className="product-inner equal-element">
                        ...
                        <img src="/../../public/assets/img/product29.png" alt="img"/>
                    ...
                    <li className="product-item product-type-variable col-lg-3 col-md-4 col-sm-6 col-xs-6 col-ts-12 style-1">
                      <div className="product-inner equal-element">
                        ...
                        <div className="product-thumb">
                          <div className="thumb-inner">
                            <a href="#">
                            <img src="/../../public/assets/img/product27.png" alt="img"/>
                    ...
                    <li className="product-item col-lg-3 col-md-4 col-sm-6 col-xs-6 col-ts-12 style-1">
                      <div className="product-inner equal-element">
                        ...
                        <img src="/../../public/assets/img/product28.png" alt="img"/>
              ...
              >
                <div className="nozari-blog-item equal-element layout1 mx-2">
                  <div className="post-thumb">
                    <a href="#">
                        <img src="/../../public/assets/images/instagram/daynew1.jpeg" alt="img"/>
                    </a>
                ...
                <div className="nozari-blog-item equal-element layout1 mx-2">
                  <div className="post-thumb">
                    <a href="#">
                    <img src="/../../public/assets/images/instagram/daynew3.jpg" alt="img"/>
                ...
                <div className="nozari-blog-item equal-element layout1 mx-2">
                  <div className="post-thumb">
                    <div className="video-nozari-blog">
                      <figure>
                      <img src="/../../public/assets/images/instagram/daynew2.jpg" alt="img"/>
            ...
            <div className="nozari-instagram">
              ...
              >
                <div className="item-instagram">
                  <a href="#">
                    <img src="/../../public/assets/images/instagram/1.jpg" alt="img"
                ...
                <div className="item-instagram">
                  <a href="#">
                  <img src="/../../public/assets/images/instagram/2.jpg" alt="img"
                      style={{ width: "302px", height: "302px" }}
                      />
                  </a>
                  <span className="text">
                ...
                <div className="item-instagram">
                  <a href="#">
                  <img src="/../../public/assets/images/instagram/3.jpg" alt="img"
                      style={{ width: "302px", height: "302px" }}
                      />
                  </a>
                  <span className="text">
                ...
                <div className="item-instagram">
                  <a href="#">
                  <img src="/../../public/assets/images/instagram/4.jpg" alt="img"
                      style={{ width: "302px", height: "302px" }}
                      />
                  </a>
                  <span className="text">
                ...
                <div className="item-instagram">
                  <a href="#">
                  <img src="/../../public/assets/images/instagram/5.jpeg" alt="img"
                      style={{ width: "302px", height: "302px" }}
                      />
                  </a>
                  <span className="text">
