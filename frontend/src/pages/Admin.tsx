...
const items2: MenuProps['items'] = [
  {
    ...
    children: [
      ...
      { key: '1-2', label: <Link to="edit-user">Edit User</Link> },
  ...
  },
  {
    ...
    children: [
      ...
      { key: '2-3', label: 'Tùy chọn 3' },
      { key: '2-4', label: 'Tùy chọn 4' },
    ],
  },
  {
    key: '3',
  ...
  },
  {
    ...
    label: 'Categories',
    children: [
      { key: '5-1', label: 'Thông báo 1' },
      { key: '5-2', label: 'Thông báo 2' },
      { key: '5-3', label: 'Thông báo 3' },
      { key: '5-4', label: 'Thông báo 4' },
    ],
  },
];
    ...
    <Layout>
      ...
      <Layout>
        ...
        <Layout style={{ padding: '0 24px 24px' }}>
          ...
          <Content style={{ padding: 24, margin: 0,   borderRadius: borderRadiusLG }}>
            <Outlet />
          </Content>
        </Layout>
      </Layout>
